...
public class WallClockWidget extends BaseWidgetProvider {
    ...
    public void UpdateWidget(Context context) {
        ...
        for (int appWidgetId : appWidgetIds) {
            ...
            Config.Log("digit h = " + h);

//            final int bmp_w = (int) ((digit_sizes[theme][hh / 10] + digit_sizes[theme][hh % 10] + digit_sizes[theme][10] +
//                    digit_sizes[theme][mm / 10] + digit_sizes[theme][mm % 10]) * density);
            ...
            bmp = Bitmap.createBitmap((int) (density * bmp_w), (int) (density * h), Bitmap.Config.ARGB_8888);
            Canvas canvas = new Canvas(bmp);
            Paint p = new Paint();
            canvas.drawRect(new Rect(0, 0, bmp.getWidth(), bmp.getHeight()), p);
            Config.Log("Bitmap size = " + bmp.getWidth() + " x " + bmp.getHeight());
            ...
            canvas.drawBitmap(digits, new Rect((int) (density * w), 0, (int) (density * (w + digit_sizes[theme][index])), (int) (density * h)),
                    new Rect((int) (density * cur_x), 0, (int) (density * (cur_x + digit_sizes[theme][index])), (int) (density * h)), p);
