...
public class AnalogClockWidget extends BaseWidgetProvider {
    ...
    private static final int[] Dials = {
            R.drawable.a_clock4, R.drawable.a_clock3, R.drawable.a_clock5,
            R.drawable.a_clock6, R.drawable.a_clock7, R.drawable.a_clock8
    };

    private static final int[] HandsM = {
            0, 0, R.drawable.a_clock5_m, R.drawable.a_clock6_m,
            R.drawable.a_clock7_m, R.drawable.a_clock7_m
    };

    private static final int[] HandsH = {
            0, 0, R.drawable.a_clock5_h, R.drawable.a_clock6_h,
            R.drawable.a_clock7_h, R.drawable.a_clock7_h
    };
    private static final int[] h_dx = {0, 0, -11, -4, -5, -5};
    private static final int[] h_dy = {0, 0, -11, -10, -8, -8};
    private static final int[] m_dx = {0, 0, -5, -4, -5, -5};
    private static final int[] m_dy = {0, 0, -11, -10, -8, -8};
