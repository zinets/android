...
public class WallClockConfig extends BaseClockConfig {
    ...
    static final String SelectedThemePrefix = "selectedTheme_wall";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        randomTheme.setChecked(prefs.getBoolean(SelectedThemePrefix + mNewWidgetId, true));
        ...
        check.setChecked(prefs.getBoolean(AltActionPrefix + mNewWidgetId, false));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (Config.LOGGING)
            Config.Log("clockColor = " + clockColor);

        final CheckBoxPreference selectedTheme = (CheckBoxPreference) findPreference("widgetRandomTheme");
        editor.putBoolean(SelectedThemePrefix + mNewWidgetId, selectedTheme.isChecked());
        Config.Log("config: use selected theme: " + selectedTheme.isChecked());
